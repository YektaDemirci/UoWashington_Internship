...
************************************************
************************************************
In this script, linear models are trained with the 
direct raw data without taking wavelet transformation
to show effect of wavelet transformation.
R^2 values are quite low(0.041) as they are expected
************************************************
************************************************
************************************************
"""
...
'''
#This function is not needed as wavelet is not used.
...
with open("C:/Users/"+userName+"/Desktop/BerkHoca/Results/0.041noWav.csv", 'w', newline='') as myfile:
