...
coefficients from level 3 Haar Wavelet transformations.
R^2 values converge to 0.44, best result obtained so far.
Haar wavelet is used.
...
with open("C:/Users/"+userName+"/Desktop/BerkHoca/Results/0.44haarWavelet.csv", 'w', newline='') as myfile:
